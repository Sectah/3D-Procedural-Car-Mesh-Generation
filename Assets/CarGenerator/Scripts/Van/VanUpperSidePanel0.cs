...
public class VanUpperSidePanel0 : MonoBehaviour {
	...
	void CreateMesh () {
		...
		Vector3 rearSlant1 = rearSlant.mesh.vertices [1];
		Vector3 rearSlant3 = rearSlant.mesh.vertices [3];
		...
		mesh.triangles = new int[] { 2,1,0, 2,3,1, 3,4,5, 5,6,1, 5,4,6 };

...
public class Van3BumperInward : MonoBehaviour {
	...
	Van2BumperStraight bumperStraight;
	...
	void Start () {
		...
		bumperStraight = FindObjectOfType<Van2BumperStraight>();
	...
	void CreateMesh () {
		...
		depth = -FindObjectOfType<Van1BumperUnderside> ().mesh.vertices [2].z;
		Vector3 previous2 = bumperStraight.mesh.vertices [2];
		Vector3 previous3 = bumperStraight.mesh.vertices [3];

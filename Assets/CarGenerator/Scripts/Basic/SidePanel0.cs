...
public class SidePanel0 : MonoBehaviour {

	//Allow for next mesh to access data from this mesh
	[HideInInspector] public Mesh mesh;

	//All the scripts I need to connect the panel to the rest of the mesh
	...
	void CreateMesh () {
		...
		Vector3 grill3 = grillScript.mesh.vertices [3];
		Vector3 grillToBonnet3 = grillToBonnetScript.mesh.vertices [3];
		Vector3 bonnet3 = bonnetScript.mesh.vertices [3];
		Vector3 bonnetToWindscreen3 = bonnetToWindscreenScript.mesh.vertices [3];
		Vector3 rearPanel1 = rearPanelScript.mesh.vertices [1];
		Vector3 rearPanel3 = rearPanelScript.mesh.vertices [3];
		Vector3 backendPanel3 = backendScript.mesh.vertices [3];
		...
		mesh.triangles = new int[] { 0,2,1, 2,3,1, 3,2,4, 4,5,1, 1,5,6, 6,5,7, 6,7,8, 8,7,9, 8,9,10, 9,11,10, 10,11,12, 12,11,13 };
